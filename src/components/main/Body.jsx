...
class Body extends Component {
    ...
    render(){
        ...
        const { ntListResponse, commentCountList ,adExposeList,aDTO } = this.state;

        //광고 노출

        let totalAdRandom = null;

        let topAdRender = null;

        let bottomAdRender = null;
            ...
            <div className="padTop124 padLR">
                ...
                <div className="sponserBanner">
                    ...
                    {/* <div className="sponDiv">
                        ...
                        <div className="sponBan1" style={{backgroundColor:'blue'}}>

                        </div>

                        <div className="sponBan1" style={{backgroundColor:'yellow'}}>
